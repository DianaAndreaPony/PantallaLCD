...
//Ventana para desplegar la hora y fecha en LCD

//Liibrerias a utilizar
...
public class hr extends JFrame {
    ...
    public hr() {
        ...
        lblmensaje = new JLabel("Fecha y Hora");
        panel1.add(lblmensaje);

        temperatura = new JButton("FECHA");
        ...
        temperatura.addActionListener(new ActionListener() {
            ...
            //Enviamos un 3 que servira en el programa  de arduino
